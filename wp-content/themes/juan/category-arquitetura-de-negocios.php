...
<?php global $post;
$my_query = new WP_Query('category_name=arquitetura-de-negocios&showposts=100'); ?>
<div class="row  cols-12" id="blog">
    ...
    <aside class=" col-3">
        <div class="Content-aside">
            ...
            <?php $my_query1 = new WP_Query('category_name=arquitetura-de-negocios&showposts=100'); ?>
